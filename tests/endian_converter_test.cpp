...
TEST_CASE("ENDIAN CONVERTER TESTCASE #2", "[endian_convert_32]") {
    ItchType::UnsignedInt32  testcase1 = 0;
    std::byte* testcase1Ptr = reinterpret_cast<std::byte*>(&testcase1);
    ItchType::UnsignedInt32 testcase2 = 1;
    std::byte* testcase2Ptr = reinterpret_cast<std::byte*>(&testcase2);
    ItchType::UnsignedInt32 testcase3 = 134480385;
    std::byte* testcase3Ptr = reinterpret_cast<std::byte*>(&testcase3);
    ItchType::UnsignedInt32 testcase4 = 256988845;
    std::byte* testcase4Ptr = reinterpret_cast<std::byte*>(&testcase4);
...
TEST_CASE("ENDIAN CONVERTER TESTCASE #3", "[endian_convert_48]") {
    ItchType::UnsignedInt64  testcase1 = 0;
    std::byte* testcase1Ptr = reinterpret_cast<std::byte*>(&testcase1);
    ItchType::UnsignedInt64 testcase2 = 281474976710655;
    std::byte* testcase2Ptr = reinterpret_cast<std::byte*>(&testcase2);
    ItchType::UnsignedInt64 testcase3 = 250569738154767;
    std::byte* testcase3Ptr = reinterpret_cast<std::byte*>(&testcase3);
    ItchType::UnsignedInt64 testcase4 = 8924960432608;
    std::byte* testcase4Ptr = reinterpret_cast<std::byte*>(&testcase4);
...
TEST_CASE("ENDIAN CONVERTER TESTCASE #4", "[endian_convert_64]") {
    ItchType::UnsignedInt64  testcase1 = 0;
    std::byte* testcase1Ptr = reinterpret_cast<std::byte*>(&testcase1);
    ItchType::UnsignedInt64 testcase2 = 0xFFFFFFFFFFFFFFFF;
    std::byte* testcase2Ptr = reinterpret_cast<std::byte*>(&testcase2);
    ItchType::UnsignedInt64 testcase3 = 7136817;
    std::byte* testcase3Ptr = reinterpret_cast<std::byte*>(&testcase3);
    ItchType::UnsignedInt64 testcase4 = 1784445853624421461;
    std::byte* testcase4Ptr = reinterpret_cast<std::byte*>(&testcase4);
