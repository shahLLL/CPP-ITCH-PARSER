...
TEST_CASE("STRUCT MAPPER TESTCASE #1", "[map_system_event_message]") {
    ...
    SystemEventMessage systemEventMessage = StructMapper::mapSystemEventMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #2", "[map_stock_directory]") {
    ...
    StockDirectory stockDirectory = StructMapper::mapStockDirectory(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #3", "[map_stock_trading_action]") {
    ...
    StockTradingAction stockTradingAction = StructMapper::mapStockTradingAction(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #4", "[map_reg_sho_restriction]") {
    ...
    RegSHORestriction regSHORestriction = StructMapper::mapRegSHORestriction(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #5", "[map_market_participation_position]") { 
    ...
    MarketParticipantPosition marketParticipationPosition = StructMapper::mapMarketParticipationPostion(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #6", "[map_mwcb_decline_level_message]") {
    ...
    MWCBDeclineLevelMessage mwcbDeclineLevelMessage = StructMapper::mapMWCBDeclineLevelMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #7", "[map_mwcb_status_message]") {
    ...
    MWCBStatusMessage mwcbStatusMessage = StructMapper::mapMWCBStatusMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #8", "[map_quotation_period_update]") {
    ...
    QuotingPeriodUpdate quotationPeriodUpdate = StructMapper::mapQuotingPeriodUpdate(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #9", "[map_luld_auction_collar]") {
    ...
    LULDAuctionCollar luldAuctionCollar = StructMapper::mapLULDAuctionCollar(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #10", "[map_operational_halt]") {
    ...
    OperationalHalt operationalHalt = StructMapper::mapOperationalHalt(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #11", "[map_add_order_message]") {
    ...
    AddOrderMessage addOrderMessage = StructMapper::mapAddOrderMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #12", "[map_add_order_mpid_attribution_message]") {
    ...
    AddOrderMPIDAttributionMessage addOrderMPIDAttributionMessage = StructMapper::mapAddOrderMPIDAttributionMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #13", "[map_order_executed_message]") {
    ...
    OrderExecutedMessage orderExecutedMessage = StructMapper::mapOrderExecutedMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #14", "[map_order_executed_with_price_message]") {
    ...
    OrderExecutedWithPriceMessage orderExecutedWithPriceMessage = StructMapper::mapOrderExecutedWithPriceMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #15", "[map_order_cancel_message]") {
    ...
    OrderCancelMessage orderCancelMessage = StructMapper::mapOrderCancelMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #16", "[map_order_delete_message]") {
    ...
    OrderDeleteMessage orderDeleteMessage = StructMapper::mapOrderDeleteMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #17", "[map_order_replace_message]") {
    ...
    OrderReplaceMessage orderReplaceMessage = StructMapper::mapOrderReplaceMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #18", "[map_trade_message]") {
    ...
    TradeMessage tradeMessage = StructMapper::mapTradeMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #19", "[map_cross_trade_message]") {
    ...
    CrossTradeMessage crossTradeMessage = StructMapper::mapCrossTradeMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #20", "[map_broken_trade_message]") {
    ...
    BrokenTradeMessage brokenTradeMessage = StructMapper::mapBrokenTradeMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #21", "[map_noii_message]") {
    ...
    NOIIMessage noiiMessage = StructMapper::mapNOIIMessage(testcase);
...
TEST_CASE("STRUCT MAPPER TESTCASE #22", "[map_dlwcrpd]") {
    ...
    DLWCRPD dlwcrpd = StructMapper::mapDLWCRPD(testcase);
